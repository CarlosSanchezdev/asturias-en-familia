...
> Los usuarios no tienen relación directa con actividades en el MVP.
> Las actividades creadas por un admin no guardan referencia a qué admin las creó.
> *(Mejora futura: campo `createdBy: ObjectId → User`)*
...
```json
{
  ...
  "images": [
    "https://example.com/ruta-oso-1.jpg",
    "https://example.com/ruta-oso-2.jpg"
  ],
  "accessible": false,
  "price": 0,
  "isFree": true,
...
```json
{
  ...
  "role": "admin",
  "active": true,
  "lastLogin": "2024-10-20T08:15:00.000Z",
  "createdAt": "2024-10-01T09:00:00.000Z",
...
**IMPORTANTE:** MongoDB y GeoJSON usan el orden `[longitud, latitud]`, que es
el opuesto al orden habitual en mapas (`[latitud, longitud]`).
...
El frontend recibe las coordenadas en este orden y las usa para el cálculo SVG.
La transformación lineal espera `coordinates[0]` como longitud y `coordinates[1]`
como latitud.
