...
## Sprint 5 — Frontend: Mapa Leaflet y marcadores (Sprint 5)

**Objetivo:** El mapa de Asturias muestra los marcadores de actividades usando Leaflet con SVG imageOverlay. Al hacer
clic en un marcador aparece el detalle.

| ID    | Tarea                                                         | Estimación | Estado |
| ----- | ------------------------------------------------------------- | ---------- | ------ |
| S5-01 | Integrar Leaflet con SVG de Asturias como imageOverlay        | 2h         | ✅     |
| S5-02 | Configurar bounds del mapa y deshabilitar tiles externos      | 1h         | ✅     |
| S5-03 | MapMarkerComponent — L.marker con DivIcon por categoría       | 3h         | ✅     |
| S5-04 | ActivitiesService — cargar y cachear actividades con signals  | 2h         | ✅     |
| S5-05 | Renderizar todos los marcadores sobre el mapa al cargar       | 2h         | ✅     |
| S5-06 | ActivityDetailComponent — panel de detalle al clicar marcador | 3h         | ✅     |
| S5-07 | Responsive: bottom sheet (móvil) / panel lateral (escritorio) | 3h         | ✅     |
| S5-08 | Animaciones de apertura/cierre del panel                      | 1h         | ✅     |
| S5-09 | Tests Jasmine: MapProjectionService — coordenadas reales      | 2h         | ✅     |
...
| Hito  | Sprint | Descripción                     | Estado |
| ----- | ------ | ------------------------------- | ------ |
